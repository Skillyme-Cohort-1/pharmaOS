      ...
      <div className="animate-in fade-in duration-500 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="flex items-center gap-2 text-slate-500 hover:text-teal-600 font-bold transition-colors bg-white border border-slate-200 px-4 py-2 rounded-lg shadow-sm"
          >
            <ArrowLeft size={18} /> Back to History
          </button>
        </div>
        
        {/* Load the NewSale component here */}
        <NewSale />
      </div>
    );
  }

  // Render the Sales History view
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button 
          ...
          className="bg-teal-600 hover:bg-teal-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all"
        >
        ...
        <div className="p-4 border-b border-slate-100">
          <div className="relative max-w-sm">
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-teal-500" 
            />
