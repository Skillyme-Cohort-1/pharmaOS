          ...
          <div className="flex items-center gap-2">
            {['', 'completed', 'pending', 'processing', 'cancelled'].map(s => (
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded transition-colors ${statusFilter === s ? 'bg-forty-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
              >
                {s || 'All'}
              </button>
            ))}
